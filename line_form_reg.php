...
<form name="captura" method="post" 
   action="insert_line.php" enctype="multipart/form-data">

   <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-3 mb-3">
      <label for="validationDefault01">Nom de la via</label>
      <input type="text" class="form-control" id="validationDefault01" name="nom_via"  required>
    </div>
  ...
  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault04" name="altura">
    </div>
    <div class="col-md-2 mb-3">
  ...
  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-2 mb-3">
      ...
      <input type="number" class="form-control" id="validationDefault06" name="n_bolts" >
    </div>
    <div class="col-md-2 mb-3">
      <?php
