...
<form id="form_cons" name="captura" method="post" 
   action="line_list.php" enctype="multipart/form-data">

  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-5 mb-3">
      <label for="validationDefault01">Nom de la via</label>
      <input type="text" class="form-control" id="validationDefault01" name="nom_via" >
    </div>
  </div>
  ...
  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault02" name="grau" >
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationDefault03">Altura</label>
      <input type="text" class="form-control" id="validationDefault03" name="altura">
    </div>
  </div>

  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-2 mb-3">
      <label for="validationDefault04">Nº de chapes</label>
      <input type="number" class="form-control" id="validationDefault04" name="n_bolts" >
    </div>
    <div class="col-md-3 mb-3">
      <?php
  ...
  <div class="form-row">&nbsp;&nbsp;
    <div class="col-md-3 mb-3">
      ...
      <label for="validationDefault05">Sector pertanyent</label>
    ...
    <div class="col-md-2 mb-3">
      ...
      <label for="validationDefault06">Estat</label>
